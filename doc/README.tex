...
\begin{itemize}
    ...
    \item \textbf{bankrupcty\_rationed}: Number of banks that failed in this step due to rationing (only when \textbf{no\_noreplace} is being used)
    ...
    \item \textbf{c}: Lender capacity ($1 - \frac{E}{E_{\max}}$) of the bank
    ...
    \item \textbf{demand}: Sum of demand of loan of borrowers not satisfied by their own capital after shock1
    ...
    \item \textbf{var\_dep\_shock1}: Amount of ($ \Delta D$) for the bank in first shock
    \item \textbf{var\_dep\_shock2}: Amount of ($ \Delta D$) for the bank in second shock
...
\textbf{var\_deposits,var\_dep\_shock1,var\_dep\_shock2} &  float &   $\sum$  &  $\sum$  &  &  $\checkmark$  \\
\textbf{ir,ir\_effective}                &  float &  $\overline{x}/0$ & $\overline{x} / nan $  & $\checkmark$ &  \\
...
\textbf{psi,psi\_effective} &  float &  $\overline{x}/0 $ & $\overline{x}/nan $ &  & $\checkmark$ \\
