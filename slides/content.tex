...
\begin{frame}[t]
  ...
  \begin{minipage}{0.85\textwidth}
    \vspace{3.5cm}
    \footnotesize
    Each of the $\binom{N}{2}$ edges is included independently with prob. $p$. For $N=50$ banks:
    \begin{itemize}
      \item $p = 0$: isolated banks, no interbank market.
      \item $p = 1/N = 0.02$: \textbf{phase transition}---giant component emerges.
      \item $p > 0.05$: network is saturated ($>92\%$ of banks connected): \textbf{supercritical regime}.
    \end{itemize}
  \end{minipage}
\end{frame}
}
