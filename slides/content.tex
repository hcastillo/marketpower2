...
\begin{frame}{Why supercritical is relevant in this model}
  \begin{columns}[T]
...
\begin{frame}[shrink=0.1]{Phase Transition}
  \begin{itemize}
    \item \textbf{Phase transition:} GCS jumps from $\sim 1$ to $\sim 46$ banks ($92\%$) as $p$ crosses the supercritical region (above $p_c=1/N$).
  ...
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      ...
      \textbf{Percolation threshold} $\langle k \rangle \approx 1$ (phase transition) for Erd\H{o}s--R\'enyi graph: \[
        ...
        \] \\
      \textbf{Supercritical region} $\langle k \rangle = 2.14$, observed at $p_s = 0.055$. \\
