        ...
        for bank in this_model.banks:
            ...
            if bank.incrD < 0:  # borrowers
                ...
                if possible_lenders:
                    ...
                    bank.lender = None
            if bank.lender != bank_old_lender:
                if bank.lender is not None:
                    result_extra.append(f"{bank.get_id()} new lender is #{bank.lender}")
                else:
                    result_extra.append(f"{bank.get_id()} no lender")
        return result_extra
