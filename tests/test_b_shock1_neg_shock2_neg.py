...
class ValuesAfterExecutionTestCase(interbank_testclass.InterbankTest):
    ...
    def test_negative_shock__of2(self):
        ...
        self.setShock2(0,-2)
        self.assertBank(0, C=0.04)
        self.model.do_repayments()
        self.model.log.debug_bank(0)
        self.assertBank(0, C=0, R=0.02, D=1, rationing=1.02, failed=True)
    ...
    def test_positive_shock_of2(self):
        ...
        self.model.do_repayments()
        self.model.log.debug_bank(0)
        self.assertBank(0, C=0.9, R=0.1, D=5, rationing=0, failed=True)
    ...
    def test_positive_shock_of1(self):
        ...
        self.model.do_repayments()
        self.model.log.debug_bank(0)
        self.assertBank(0, C=0, R=0.08, D=4, rationing=0.08, failed=True)
